...
namespace iEvent.Infrastructure.Migrations
{
    ...
    [Migration("20260713071736_RemoveRedundantImageUrlFromEvent")]
    partial class RemoveRedundantImageUrlFromEvent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iEvent.Domain.Entities.VenueFacility", b =>
                {
            ...
            modelBuilder.Entity("iEvent.Domain.Entities.VenueImage", b =>
                {
                    b.Property<Guid>("ImageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("iEvent.Domain.Entities.Booking", b =>
                {
                    b.HasOne("iEvent.Domain.Entities.EventTimeSlot", "BookingTimeSlot")
                        .WithMany()
                        .HasForeignKey("BookingTimeSlotId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("iEvent.Domain.Entities.AdminUser", "CollectedBy")
                        .WithMany()
